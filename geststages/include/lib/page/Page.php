        ...
        <form action="" method="POST">
            <table class="connection">
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="type" id="type" value="eleve" /><label for="eleve">Etudiant </label>
                        <input type="radio" name="type" id="type" value="prof" /><label for="prof">Professeur </label>
                    </td>
                </tr>
                <tr>
                    <td></td>
